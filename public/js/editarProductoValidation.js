...
editar.onmousedown = function (e) {
    ...
    for (let i = 1; i < 4; i++) {
        ...
        if (length == 0 && lengthText == 0 && (selects[0].value == 'Selecciona una opción' && selects[1]
                .value == 'Selecciona una opción' && selects[2].value == 'Selecciona una opción') && (inputs[4].disabled && inputs[5].disabled)) {
